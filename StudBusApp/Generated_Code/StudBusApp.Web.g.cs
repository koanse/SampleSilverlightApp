...
namespace StudBusApp.Web
{
    ...
    public sealed partial class RegistrationData : Entity
    {
        ...
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references a property 'ValidationErrorRequiredField' on type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'.
        // [RequiredAttribute(ErrorMessageResourceName = "ValidationErrorRequiredField", ErrorMessageResourceType = typeof(StudBusApp.Web.Resources.ValidationErrorResources))]
        // 
        [DataMember()]
        [Display(Name="SecurityAnswerLabel", Order=6, ResourceType=typeof(StudBusApp.Web.Resources.RegistrationDataResources))]
        ...
        // Unable to generate the following attribute(s) due to the following error(s):
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.RegularExpressionAttribute' references type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.RegularExpressionAttribute' references a property 'ValidationErrorInvalidEmail' on type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'.
        // [RegularExpressionAttribute("^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$", ErrorMessageResourceName = "ValidationErrorInvalidEmail", ErrorMessageResourceType = typeof(StudBusApp.Web.Resources.ValidationErrorResources))]
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references a property 'ValidationErrorRequiredField' on type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'.
        // [RequiredAttribute(ErrorMessageResourceName = "ValidationErrorRequiredField", ErrorMessageResourceType = typeof(StudBusApp.Web.Resources.ValidationErrorResources))]
        // 
        [DataMember()]
        [Display(Name="EmailLabel", Order=2, ResourceType=typeof(StudBusApp.Web.Resources.RegistrationDataResources))]
        ...
        // Unable to generate the following attribute(s) due to the following error(s):
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.StringLengthAttribute' references type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.StringLengthAttribute' references a property 'ValidationErrorBadFriendlyNameLength' on type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'.
        // [StringLengthAttribute(255, ErrorMessageResourceName = "ValidationErrorBadFriendlyNameLength", ErrorMessageResourceType = typeof(StudBusApp.Web.Resources.ValidationErrorResources))]
        // 
        [DataMember()]
        [Display(Description="FriendlyNameDescription", Name="FriendlyNameLabel", Order=1, ResourceType=typeof(StudBusApp.Web.Resources.RegistrationDataResources))]
        ...
        // 
        [DataMember()]
        [Display(Name="SecurityQuestionLabel", Order=5, ResourceType=typeof(StudBusApp.Web.Resources.RegistrationDataResources))]
        ...
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.RegularExpressionAttribute' references type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.RegularExpressionAttribute' references a property 'ValidationErrorInvalidUserName' on type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'.
        // [RegularExpressionAttribute("^[a-zA-Z0-9_]*$", ErrorMessageResourceName = "ValidationErrorInvalidUserName", ErrorMessageResourceType = typeof(StudBusApp.Web.Resources.ValidationErrorResources))]
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references a property 'ValidationErrorRequiredField' on type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'.
        // [RequiredAttribute(ErrorMessageResourceName = "ValidationErrorRequiredField", ErrorMessageResourceType = typeof(StudBusApp.Web.Resources.ValidationErrorResources))]
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.StringLengthAttribute' references type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.StringLengthAttribute' references a property 'ValidationErrorBadUserNameLength' on type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'.
        // [StringLengthAttribute(255, ErrorMessageResourceName = "ValidationErrorBadUserNameLength", ErrorMessageResourceType = typeof(StudBusApp.Web.Resources.ValidationErrorResources), MinimumLength = 4)]
        // 
        [DataMember()]
        [Display(Name="UserNameLabel", Order=0, ResourceType=typeof(StudBusApp.Web.Resources.RegistrationDataResources))]
        [Editable(false, AllowInitialValue=true)]
        [Key()]
        [RoundtripOriginal()]
    ...
    public sealed partial class StudDomainContext : DomainContext
    {
        ...
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="Студент"/> entities using the 'GetСтудентГруппыБезОценокПоДисциплине' query.
        /// </summary>
        /// <param name="КодГруппы">The value for the 'КодГруппы' parameter of the query.</param>
        /// <param name="КодДисциплины">The value for the 'КодДисциплины' parameter of the query.</param>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="Студент"/> entities.</returns>
        public EntityQuery<Студент> GetСтудентГруппыБезОценокПоДисциплинеQuery(int КодГруппы, int КодДисциплины)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("КодГруппы", КодГруппы);
            parameters.Add("КодДисциплины", КодДисциплины);
            this.ValidateMethod("GetСтудентГруппыБезОценокПоДисциплинеQuery", parameters);
            return base.CreateQuery<Студент>("GetСтудентГруппыБезОценокПоДисциплине", parameters, false, true);
        }
        
        /// <summary>
        /// Asynchronously invokes the 'GetAvgОценкаByГруппаДисциплина' method of the domain service.
        /// </summary>
        ...
        public InvokeOperation<double> GetAvgОценкаByГруппаДисциплина(int КодДисциплины, int КодГруппы, Action<InvokeOperation<double>> callback, object userState)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("КодДисциплины", КодДисциплины);
            parameters.Add("КодГруппы", КодГруппы);
            this.ValidateMethod("GetAvgОценкаByГруппаДисциплина", parameters);
            return ((InvokeOperation<double>)(this.InvokeOperation("GetAvgОценкаByГруппаДисциплина", typeof(double), parameters, true, callback, userState)));
        }
        ...
        /// <param name="КодГруппы">The value for the 'КодГруппы' parameter of this action.</param>
        /// <returns>An operation instance that can be used to manage the asynchronous request.</returns>
        public InvokeOperation<double> GetAvgОценкаByГруппаДисциплина(int КодДисциплины, int КодГруппы)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("КодДисциплины", КодДисциплины);
            parameters.Add("КодГруппы", КодГруппы);
            this.ValidateMethod("GetAvgОценкаByГруппаДисциплина", parameters);
            return ((InvokeOperation<double>)(this.InvokeOperation("GetAvgОценкаByГруппаДисциплина", typeof(double), parameters, true, null, null)));
        }
        ...
        public interface IStudDomainServiceContract
        {
            ...
            /// <summary>
            /// Asynchronously invokes the 'GetAvgОценкаByГруппаДисциплина' operation.
            /// </summary>
            /// <param name="КодДисциплины">The value for the 'КодДисциплины' parameter of this action.</param>
            /// <param name="КодГруппы">The value for the 'КодГруппы' parameter of this action.</param>
            /// <param name="callback">Callback to invoke on completion.</param>
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/StudDomainService/GetAvgОценкаByГруппаДисциплинаDomainServiceF" +
                "ault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/StudDomainService/GetAvgОценкаByГруппаДисциплина", ReplyAction="http://tempuri.org/StudDomainService/GetAvgОценкаByГруппаДисциплинаResponse")]
            IAsyncResult BeginGetAvgОценкаByГруппаДисциплина(int КодДисциплины, int КодГруппы, AsyncCallback callback, object asyncState);
            
            /// <summary>
            /// Completes the asynchronous operation begun by 'BeginGetAvgОценкаByГруппаДисциплина'.
            /// </summary>
            /// <param name="result">The IAsyncResult returned from 'BeginGetAvgОценкаByГруппаДисциплина'.</param>
            /// <returns>The 'Double' returned from the 'GetAvgОценкаByГруппаДисциплина' operation.</returns>
            double EndGetAvgОценкаByГруппаДисциплина(IAsyncResult result);
            ...
            /// <summary>
            /// Asynchronously invokes the 'GetСтудентГруппыБезОценокПоДисциплине' operation.
            /// </summary>
            /// <param name="КодГруппы">The value for the 'КодГруппы' parameter of this action.</param>
            /// <param name="КодДисциплины">The value for the 'КодДисциплины' parameter of this action.</param>
            /// <param name="callback">Callback to invoke on completion.</param>
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/StudDomainService/GetСтудентГруппыБезОценокПоДисциплинеDomainS" +
                "erviceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/StudDomainService/GetСтудентГруппыБезОценокПоДисциплине", ReplyAction="http://tempuri.org/StudDomainService/GetСтудентГруппыБезОценокПоДисциплинеRespons" +
                "e")]
            [WebGet()]
            IAsyncResult BeginGetСтудентГруппыБезОценокПоДисциплине(int КодГруппы, int КодДисциплины, AsyncCallback callback, object asyncState);
            
            /// <summary>
            /// Completes the asynchronous operation begun by 'BeginGetСтудентГруппыБезОценокПоДисциплине'.
            /// </summary>
            /// <param name="result">The IAsyncResult returned from 'BeginGetСтудентГруппыБезОценокПоДисциплине'.</param>
            /// <returns>The 'QueryResult' returned from the 'GetСтудентГруппыБезОценокПоДисциплине' operation.</returns>
            QueryResult<Студент> EndGetСтудентГруппыБезОценокПоДисциплине(IAsyncResult result);
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.RegularExpressionAttribute' references type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.RegularExpressionAttribute' references a property 'ValidationErrorBadPasswordStrength' on type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'.
        // [RegularExpressionAttribute("^.*[^a-zA-Z0-9].*$", ErrorMessageResourceName = "ValidationErrorBadPasswordStrength", ErrorMessageResourceType = typeof(StudBusApp.Web.Resources.ValidationErrorResources))]
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references a property 'ValidationErrorRequiredField' on type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'.
        // [RequiredAttribute(ErrorMessageResourceName = "ValidationErrorRequiredField", ErrorMessageResourceType = typeof(StudBusApp.Web.Resources.ValidationErrorResources))]
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.StringLengthAttribute' references type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.StringLengthAttribute' references a property 'ValidationErrorBadPasswordLength' on type 'StudBusApp.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'StudBusApp.csproj'.
        // [StringLengthAttribute(50, ErrorMessageResourceName = "ValidationErrorBadPasswordLength", ErrorMessageResourceType = typeof(StudBusApp.Web.Resources.ValidationErrorResources), MinimumLength = 7)]
        // 
